...
<body>
    ...
    <main>
        <div class="container white-text">
            <h3>
                Jeśli masz jakiekolwiek pytania, wątpliwości lub sugestie dotyczące naszej strony "CarMate" lub
                chciałbyś
            ...
            <ul>
                <li>Adres: CarMate Inc., ul. Przykładowa 123, 00-000 Miasto, Kraj</li>
                <li>Adres e-mail: info@carmate.com</li>
            ...
            <h3>
                Dziękujemy za zainteresowanie stroną "CarMate" i czekamy na Twoją wiadomość. Postaramy się jak
                najlepiej
