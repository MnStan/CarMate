    ...
    <main>
        <div class="container white-text">
            <h2>
                ...
                użytkowników
                na
                stronie "CarMate". Dbamy o prywatność naszych użytkowników i zobowiązujemy się do zapewnienia
                bezpieczeństwa
                ich
            ...
            <ul>
                <li>
                    1.1. Podczas rejestracji konta i korzystania z naszej strony "CarMate", możemy zbierać pewne dane
                    osobowe,
                    takie
            ...
            <ul>
                <li>
                    ...
                    z
                    funkcji
                    strony "CarMate" oraz do prowadzenia działań marketingowych i promocyjnych.
                </li>
                <li>
                    2.2. Możemy wykorzystywać dane osobowe w celu kontaktowania się z użytkownikami w celu dostarczania
                    informacji o
                    usługach, aktualizacjach, promocjach i ofertach specjalnych.
                </li>
                <li>
